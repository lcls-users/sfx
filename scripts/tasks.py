...
def test_serv_client(config):
    ...
    command += "; conda activate /sdf/group/lcls/ds/tools/conda_envs/env_nath; which python; echo 'Client environment activated'; export PATH=/sdf/group/lcls/ds/tools/cuda11.7/bin:$PATH"
