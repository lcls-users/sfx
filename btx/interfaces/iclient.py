...
if __name__ == "__main__":
    ...
    run_client_task(exp,run,det_type,num_images,num_components,batch_size,filename_with_tag,all_data,training_percentage,smoothing_function,2) # 4 is the number of gpus, will be changed to a parameter
    print('Pipca is done!')
