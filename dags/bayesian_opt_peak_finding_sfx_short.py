"""
File: bayesian_opt_peak_finding_sfx_short.py
Author: Paul-Emile Giacomelli
Date: Winter 2023
Description: DAG for Bayesian optimization applied to peak finding - Short version to perform tests
"""
...
# DAG SETUP
description='BTX Bayesian Optimization Peak Finding SFX DAG - Short version to perform tests'
