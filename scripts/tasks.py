...
def t_sne(config):
    ...
    js = JobScheduler(os.path.join(".", f't_snes_{sum(num_images_str)}.sh'),queue = 'ampere', ncores=  1, jobname=f't_snes_{sum(num_images_str)}',logdir='/sdf/home/n/nathfrn/btx/scripts',account='lcls',mem = '200G',num_gpus = 4) ##
    js.write_header()
