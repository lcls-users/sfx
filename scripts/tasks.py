...
def test_serv_client(config):
    ...
    js = JobScheduler(os.path.join(".", f'test_serv_client.sh'),queue = 'ampere', ncores=1, jobname=f'test_serv_client_{num_components}_{num_images}',logdir='/sdf/home/n/nathfrn/btx/scripts',account='lcls:mfxp23120')
    js.write_header()
