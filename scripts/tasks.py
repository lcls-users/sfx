...
def test_serv_client(config):
    ...
    js = JobScheduler(os.path.join(".", f'test_serv_client_{num_components}_{num_images}_{batch_size}.sh'),queue = 'ampere', ncores=  1, jobname=f'test_serv_client_{num_components}_{num_images}_{batch_size}',logdir='/sdf/home/n/nathfrn/btx/scripts',account='lcls')
    js.write_header()
